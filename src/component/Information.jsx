...
import { ChevronDown, ChevronUp, MapPin, Play, Eye, AlertTriangle, Shield, Book, Calendar, Clock, Users, Phone, X, FileText, Download, ExternalLink } from "lucide-react";
      ...
      <div className="fixed top-0 left-0 w-full z-20 bg-black/80 bg-opacity-50 backdrop-blur-md border-b border-red-500/20">
        <div className="flex justify-between items-center px-6 py-4">
          ...
          <nav className="hidden md:flex gap-8 text-white font-medium">
            ...
            <a href="/information"  className="text-red-400 border-b-2 border-red-400">
              Mitigasi
            </a>
